...
public class StudentCourseRegistrationSystem {
    public static void main(String[] args) {
        ...
        courseDatabase
                .addCourse(new Course("CS101", "Intro to Java", "Introduction to Java Programming", 30, "MWF 9:00 AM"));
        ...
        courseDatabase.addCourse(
                new Course("CS104", "Database Systems", "Introduction to Database Management", 25, "TTH 10:00 AM"));
        courseDatabase.addCourse(
                new Course("CS105", "Web Development", "Introduction to Web Development", 30, "MWF 3:00 PM"));
        courseDatabase
                .addCourse(new Course("CS106", "Artificial Intelligence", "Introduction to AI", 20, "TTH 3:00 PM"));
        courseDatabase
                .addCourse(new Course("CS107", "Computer Networks", "Introduction to Networking", 25, "MWF 10:00 AM"));
        courseDatabase.addCourse(
                new Course("CS108", "Operating Systems", "Introduction to Operating Systems", 20, "TTH 1:00 PM"));
        courseDatabase.addCourse(
                new Course("CS109", "Computer Graphics", "Introduction to Computer Graphics", 30, "MWF 2:00 PM"));
        courseDatabase.addCourse(
                new Course("CS110", "Software Engineering", "Introduction to Software Engineering", 25, "TTH 9:00 AM"));
